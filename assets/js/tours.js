...
console.log(tourId);
    ...
    else if(tourId == "tour2")
    {
        ...
        h2PointC.innerHTML = "Immigration Museum of Sao Paulo State";
        ...
        imgPointB.src = "/assets/images/tours/museu_imigracao.jpg"; 
        imgPointC.src = "/assets/images/tours/tomie_ohtake.jpg"; 
    }
